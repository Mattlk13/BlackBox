...
##              print(episode[0]+'\n'+episode[1]+'\n'+episode[4])
            ...
            if(flag1==1):
##              print("flag1")
              f.write(episode[1]+","+episode[4]+"\n")

            else:
              return("Sorry next seas and ep info not found")
...
##                print((str(date).split("\"")[3].strip("GMT")))
                f.write(show1+"+"+str(date).split("\"")[3]+",")
